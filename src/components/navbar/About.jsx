        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="text-center">
                ...
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto leading-relaxed">
                    A simple platform to capture life experiences as lessons, keep them
                    organized, and share meaningful wisdom with the community.
                </p>

                <div className="mt-6 flex flex-wrap justify-center gap-3">
                    <Link to="/lessons" className="btn btn-warning text-white">
                        Explore Public Lessons
                    </Link>
                    <Link to="/dashboard/add-lesson" className="btn btn-outline btn-warning">
                        Create a Lesson
                    </Link>
                </div>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="rounded-xl border border-orange-100 bg-white p-6 shadow-sm">
                    ...
                    <p className="text-sm text-gray-600 mt-2 leading-relaxed">
                        Help people preserve personal wisdom through reflection and structured
                        life lessons—so valuable insights aren’t lost over time.
                    </p>
                </div>

                <div className="rounded-xl border border-orange-100 bg-white p-6 shadow-sm">
                    <h2 className="text-lg font-bold text-gray-900">Vision</h2>
                    <p className="text-sm text-gray-600 mt-2 leading-relaxed">
                        Build a respectful community where lessons are shared without judgment
                        and learning becomes a daily habit.
                    </p>
                </div>
            </div>
            ...
            <div className="mt-10 rounded-xl border border-orange-100 bg-orange-50 p-6">
                <h3 className="font-bold text-gray-900">What you can do here</h3>
